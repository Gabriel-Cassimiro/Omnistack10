import React, { useState, useEffect } from 'react'; //Para fazer uma ação uma úica vez
...
function Main({ navigation }) {
        ...
        async function loadInitialPosition() {
            ...
            if (granted) {
                ...
                setCurrentRegion({
                    latitude,
                    longitude,
                    latitudeDelta: 0.04, //Calculos navais
                    longitudeDelta: 0.04, //Feitos Para obter zoom no mapa
                }) //54:28
            }
        }
    ...
    async function handleRegionChange(region) {
        //console.log(region); Ver a região atual quando o usuário mecher no mapa
